...
//receives usb_tx in real sim time instead of counting sys_clk edges - bit
//period is an exact multiple of sys_clk (434 cycles @ 50mhz, no fractional
//drift) so fixed delay sampling stays aligned across all 6 bytes
module tb_uart;
